...
const Notifications = () => {
  ...
  useEffect(() => {
    setSocket(socketIOClient("http://192.168.1.39:7000/"));
    return () => {
  ...
  useEffect(() => {
    axios
      .get("http://192.168.1.39:7000/bmr-form/get-user-notifications", {
        headers: {
  ...
  const markNotificationsAsRead = (notificationIds) => {
    axios
      .put(
        "http://192.168.1.39:7000/bmr-form/read-notification",
        {
