...
const EditRecordModal = ({ onClose, bmrData, fetchBMRData }) => {
  ...
  const updateBMR = (e) => {
    ...
    axios.put(`http://localhost:7000/bmr-form/edit-bmr/${bmrData.bmr_id}`, updatedBMRData, {
      headers: {
  ...
  useEffect(() => {
    const fetchRoles = async () => {
      try {
        const reviewerResponse = await axios.post("http://localhost:7000/bmr-form/get-user-roles", {
          role_id: 3,
        }, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("user-token")}`,
        ...
        const approverResponse = await axios.post("http://localhost:7000/bmr-form/get-user-roles", {
          role_id: 4,
        }, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("user-token")}`,
