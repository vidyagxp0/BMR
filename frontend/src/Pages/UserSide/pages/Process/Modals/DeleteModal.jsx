    ...
    try {
      ...
      if (itemType === "tab") {
        const response = await axios.delete(
          `http://https://bmrapi.mydemosoftware.com:7000/bmr-form/delete-bmr-tab/${id}`,
          commonConfig,
          {
        ...
        const response = await axios.delete(
          `http://https://bmrapi.mydemosoftware.com:7000/bmr-form/delete-bmr-section/${section_id}`,
          commonConfig
        );
        ...
        const response = await axios.delete(
          `http://https://bmrapi.mydemosoftware.com:7000/bmr-form/delete-bmr-field/${bmr_field_id}`,
          commonConfig,
          {
            email: verified.email,
            password: verified.password,
