...
const AddSectionModal = ({ closeModal, addSection,bmr_tab_id , bmr_section_id , updateSection , existingSectionName }) => {
  ...
  if(updateSection === "add-section"){
    try {
      const response = await axios.post(`http://192.168.1.20:7000/bmr-form/add-bmr-section`,
        {
          bmr_id: bmr_id,
      ...
      try {
        const response = await axios.put(`http://192.168.1.20:7000/bmr-form/edit-bmr-section/${bmr_section_id}`,
          {
            bmr_id: bmr_id,
            bmr_tab_id: bmr_tab_id,
            section_name: sectionName,
